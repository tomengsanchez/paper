...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/library/create" class="btn btn-primary">Add Project</a>
</div>
<div class="card">
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/library/edit/<?= (int)$p->id ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                        <a href="/library/delete/<?= (int)$p->id ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this project?')">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
