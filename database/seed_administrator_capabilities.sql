...
UNION SELECT r.id, 'view_email_settings' FROM roles r WHERE r.name = 'Administrator'
UNION SELECT r.id, 'manage_email_settings' FROM roles r WHERE r.name = 'Administrator'
UNION SELECT r.id, 'view_security_settings' FROM roles r WHERE r.name = 'Administrator'
UNION SELECT r.id, 'manage_security_settings' FROM roles r WHERE r.name = 'Administrator'
