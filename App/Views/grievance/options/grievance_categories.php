        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/grievance/options/categories/edit/<?= (int)$i->id ?>" class="btn btn-sm btn-outline-primary">Edit</a> <a href="/grievance/options/categories/delete/<?= (int)$i->id ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete?')">Delete</a></td>
                </tr>
                <?php endforeach; ?>
