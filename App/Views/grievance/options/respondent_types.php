        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/grievance/options/respondent-types/edit/<?= (int)$i->id ?>" class="btn btn-sm btn-outline-primary">Edit</a> <form method="post" action="/grievance/options/respondent-types/delete/<?= (int)$i->id ?>" class="d-inline" onsubmit="return confirm('Delete?');"><?= \Core\Csrf::field() ?><button type="submit" class="btn btn-sm btn-outline-danger">Delete</button></form></td>
                </tr>
                <?php endforeach; ?>
